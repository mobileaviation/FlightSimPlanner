...
public class RouteController {
    public RouteController(Activity activity, Route flightPlan)
    {
    ...
    private final String TAG = "RouteController";

    private OnRouteEvent onFlightplanEvent;
    public void SetOnFlightplanEvent(OnRouteEvent onFlightplanEvent)
    ...
    public void MoveWaypoint2(Route flightPlan)
    {
        //Update the database
