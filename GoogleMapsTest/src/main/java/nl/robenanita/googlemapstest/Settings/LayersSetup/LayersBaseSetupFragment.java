...
public class LayersBaseSetupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (typeMap != null)
        {
            if (typeMap == GoogleMap.MAP_TYPE_HYBRID) radioGroup.check(R.id.layersBaseHybridBtn);
            if (typeMap == GoogleMap.MAP_TYPE_NONE) radioGroup.check(R.id.layersBaseNoneBtn);
            if (typeMap == GoogleMap.MAP_TYPE_NORMAL) radioGroup.check(R.id.layersBaseNormalBtn);
            if (typeMap == GoogleMap.MAP_TYPE_SATELLITE) radioGroup.check(R.id.layersBaseSatelliteBtn);
            if (typeMap == GoogleMap.MAP_TYPE_TERRAIN) radioGroup.check(R.id.layersBaseTerrainBtn);
        }
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (onBaseMapTypeChanged != null) onBaseMapTypeChanged.onMapTypeChanged(mapType);
