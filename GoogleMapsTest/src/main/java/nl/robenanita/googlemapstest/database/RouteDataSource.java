...
public class RouteDataSource {
    ...
    private ContentValues createFlightPlanContentValues(Route flightPlan)
    {
    ...
    public void UpdateFlightplanWind(Route flightPlan)
    {
    ...
    public Integer InsertnewFlightPlan(Route flightPlan)
    {
...
//            database.delete(DBHelper.RUNWAY_TABLE_NAME, DBHelper.C_airport_id + " =?", args);
    ...
    public void DeleteFlightplan(Route flightPlan)
    {
    ...
    public Route GetWaypointsByFlightPlan(Route flightPlan)
    {
    ...
    public void updateWaypointSortOrder(Route flightPlan)
    {
    ...
    public void updateWaypointSortOrderDB(Route flightPlan)
    {
    ...
    public void MoveWaypointDown(Route flightPlan, Waypoint waypoint)
    {
    ...
    public void MoveWaypointUp(Route flightPlan, Waypoint waypoint)
    {
        int currentOrder = waypoint.order;
        int i = 0;
        int newOrder = 0;
    ...
    public void clearTimes(Route flightPlan, boolean doUpdate)
    {
    ...
    public void resetCourses(Route flightPlan, boolean doUpdate)
    {
        for (Waypoint w: flightPlan.Waypoints)
        {
    ...
    public ArrayList<Route> GetAllFlightplans()
    {
        ArrayList<Route> flightPlans = new ArrayList<Route>();
        ...
        while (!cursor.isAfterLast())
        {
            Route flightPlan = new Route(null);
    ...
    public Route GetFlightplanByID(Integer id, Route flightPlan)
    {
    ...
    private Route cursorToFlightplan(Cursor cursor, Route flightPlan)
    {
    ...
    public void calculateETO(Date TakeoffDate, Route flightPlan)
    {
        for (Waypoint waypoint : flightPlan.Waypoints)
        {
    ...
    public void setATOcalculateRETO(Waypoint waypoint, Route flightPlan)
    {
